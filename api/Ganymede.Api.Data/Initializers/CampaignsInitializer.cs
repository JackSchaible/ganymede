...
namespace Ganymede.Api.Data.Initializers
{
    ...
    {
        public void Initialize(ApplicationDbContext ctx, string userId, Ruleset fifth, Ruleset pf, IEnumerable<Monster> dAndDMonsters, IEnumerable<Monster> pfMonsters, out Campaign pota)
        {
            ...
            {
                List<Campaign> campaigns = CreateCampaigns(userId, fifth, pf, dAndDMonsters, pfMonsters);
        ...
        private List<Campaign> CreateCampaigns(string userId, Ruleset fifth, Ruleset pf, IEnumerable<Monster> dAndDmonsters, IEnumerable<Monster> pfMonsters)
        {
            return new List<Campaign>
            {
                new Campaign
                {
                    ...
                    RulesetID = fifth.ID,
                    Monsters = dAndDmonsters as ICollection<Monster>
                },
                new Campaign
                {
                    AppUserId = userId,
                    ...
                    RulesetID = pf.ID,
                    Monsters = pfMonsters as ICollection<Monster>
                }
            };
        }
    }
