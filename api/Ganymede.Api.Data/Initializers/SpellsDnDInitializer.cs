...
namespace Ganymede.Api.Data.Initializers
{
    internal class SpellsDnDInitializer
    {
        ...
        public List<Spell> Initialize(ApplicationDbContext ctx, IEnumerable<SpellSchool> schools, int dbCampaignID)
        {
            var spells = new List<Spell>();

            SetSpellData(ctx, schools, dbCampaignID);
        ...
        public void SetSpellData(ApplicationDbContext ctx, IEnumerable<SpellSchool> schools, int dbCampaignID)
        {
