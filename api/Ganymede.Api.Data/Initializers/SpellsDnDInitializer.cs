...
namespace Ganymede.Api.Data.Initializers
{
    internal class SpellsDnDInitializer
    {
        ...
        public List<Spell> Initialize(ApplicationDbContext ctx, int dbCampaignID)
        {
            var spells = new List<Spell>();

            SetSpellData(ctx, dbCampaignID);
        ...
        public void SetSpellData(ApplicationDbContext ctx, int dbCampaignID)
        {
