...
using Ganymede.Api.Data.Initializers.Monsters.DandD.SRD;
...
namespace Ganymede.Api.Data.Initializers.Monsters
{
    ...
    {
        public void Initialize(ApplicationDbContext ctx, MarkdownParser parser, Campaign pota,
            AlignmentData alignments, DiceRollData diceRolls, ArmorData armors, LanguageData languages,
            SkillData skills, PlayerClassData pcData, SpellData spells,
