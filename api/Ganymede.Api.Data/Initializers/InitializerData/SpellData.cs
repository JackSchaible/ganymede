...
namespace Ganymede.Api.Data.Initializers.InitializerData
{
    internal class SpellData
    {
        ...
        public Spell RayOfFrost { get; set; }
        public Spell ShockingGrasp { get; set; }
        ...
        //Lvl 4
        public Spell IceStorm { get; set; }
        public Spell StormSphere { get; set; }
        
        //Lvl 5
        public Spell Cloudkill { get; set; }
        public Spell Seeming { get; set; }

        //Lvl6
        public Spell ChainLightning { get; set; }
    }
}
