...
export class MonsterComponent implements OnChanges, OnInit {
	@Input()
	monster: Monster;
	...
	constructor(private calc: CalculatorService) {
		...
		this.monster = new Monster(
			...
			[
				...
				new Description(
					"Ram",
					"<i>Melee Weapon Attack:</i> -8 to hit, reach 5 ft., one target. <i>Hit:</i> (2d4+1) bludgeoning damage. The target is grappled (escape DC12 + your proficiency) The Space Whale can grapple two targets at once."
				)
			],
			null,
			[]
	...
	private CalculateValues(): void {
		...
		var c = this.monster ? this.monster.Challenge : 0;
